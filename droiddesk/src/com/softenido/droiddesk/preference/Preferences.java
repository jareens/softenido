...
public class Preferences
{
    ...
    {
        SharedPreferences sp = (sharedPreferences!=null)? sharedPreferences : (sharedPreferences = pa.getPreferenceScreen().getSharedPreferences());
        if(preference instanceof CheckBoxPreference)
        {
            boolean entry = sp.getBoolean(preference.getKey(), false);
            preference.setSummary(String.format(summary,entry));
        }
        else if(preference instanceof ListPreference)
        {
            String entry = sp.getString(preference.getKey(),"");
            preference.setSummary(String.format(summary,entry));
        }
        else
        {
