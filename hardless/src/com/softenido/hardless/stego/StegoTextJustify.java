 ...
 *
 */
package com.softenido.hardless.stego;

import com.softenido.hardless.math.FastMath;
import com.softenido.hardless.security.SecureBitSet;
import com.softenido.hardless.util.BitSetReader;
import com.softenido.hardless.util.BitSetWriter;
import com.softenido.hardless.util.BitSets;
...
public class StegoTextJustify
{
    ...
    public String justify(String txt) throws NoSuchAlgorithmException, Exception
    {
        byte[] msg;
        int    msgsize;
    ...
    public String pack(final String txt,final byte[] msg,final byte[] pass) throws NoSuchAlgorithmException, Exception
    {
    ...
    String mergeLine(String[] words,BitSetReader br,boolean tail) throws Exception
    {
        if (words.length == 0)
        {
            return "";
