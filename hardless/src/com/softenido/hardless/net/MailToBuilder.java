 ...
 *
 */
package com.softenido.hardless.net;
...
public class MailToBuilder
{
    ...
    public String build(List<String> to,List<String> cc,List<String> bcc, String subject, String body) throws IOException, URISyntaxException
    {
    ...
    public String build(List<String> to,String subject, String body) throws IOException, URISyntaxException
    {
