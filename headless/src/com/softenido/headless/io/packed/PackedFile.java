 ...
 * @author franci
 */
public class PackedFile implements Comparable<PackedFile>, Cloneable
{
    ...
    public int compareTo(PackedFile other)
    {
        return path.compareTo(other.path);
    }

    @Override
    public PackedFile clone() throws CloneNotSupportedException
    {
        return (PackedFile) super.clone();
    }
