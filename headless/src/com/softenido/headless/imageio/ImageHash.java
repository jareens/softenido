 ...
 *
 */
package com.softenido.headless.imageio;

import com.softenido.headless.image.FixedScaleDimension;
import com.softenido.headless.io.packed.PackedFile;
import com.softenido.headless.io.packed.PackedPool;
...
public class ImageHash implements Comparable<ImageHash>
{
    ...
    private static final ScaleImage scale = new ScaleImage(new FixedScaleDimension(SIZE,SIZE),false);
