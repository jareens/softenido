/*
 * NaiveSerialClassifierTest.java
 *
 ...
 * @author franci
 */
public class NaiveSerialClassifierTest
{
    String [][] LEARN= 
    {
    ...
    public NaiveSerialClassifierTest()
    {
    }
    ...
    {
        NaiveSerialClassifier classifier = new NaiveSerialClassifier();
        
        for(int i=0;i<LEARN.length;i++)
        {
            String lang = LEARN[i][0];
            InputStream gz = new GZIPInputStream(NaiveSerialClassifierTest.class.getResourceAsStream(LEARN[i][1]));    
